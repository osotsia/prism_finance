...
def demonstrate_unit_mismatch():
    ...
    with Canvas() as model:
        ...
        revenue = Var(100.0, name="Revenue", unit="USD")
        volume = Var(50.0, name="Volume", unit="MWh")
...
def demonstrate_temporal_mismatch():
    ...
    with Canvas() as model:
        ...
        opening_balance = Var(1000.0, name="Opening Balance", temporal_type="Stock")
        closing_balance = Var(1200.0, name="Closing Balance", temporal_type="Stock")
...
def demonstrate_valid_model():
    ...
    with Canvas() as model:
        ...
        revenue = Var(100.0, name="Revenue", unit="USD", temporal_type="Flow")
        costs = Var(40.0, name="Costs", unit="USD", temporal_type="Flow")
