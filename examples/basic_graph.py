...
def demonstrate_graph_operations():
    ...
    # The Canvas context manager defines the scope of a single model.
    with Canvas() as model:
        # Create constant variables (nodes) using the Var constructor.
        revenue = Var(100.0, name="Revenue")
        costs = Var(40.0, name="Costs")
        units_sold = Var(10.0, name="Units Sold")
        initial_balance = Var(1000.0, name="Initial Balance")
